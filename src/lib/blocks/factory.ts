  ...
  switch (resolvedBlockId) {
    ...
    case "navbar-minimal": {
      ...
      return `<nav data-sz-section-id="${id}" data-sz-section-type="navbar" data-sz-section-name="Navbar Minimal" ${widgetAttrs("navbar-minimal", "Navbar Minimal", [
        { key: "brand", label: "Brand", type: "text", placeholder: siteName },
        { key: "ctaLabel", label: "CTA Label", type: "text", placeholder: "Book a call" },
      ], navbarMinimalState)} style="position:sticky;top:0;z-index:40;padding:18px 32px;background:${tokens.bg};font-family:'${tokens.bodyFont}',system-ui,sans-serif;"><div style="width:min(100%,${tokens.containerWidth});margin:0 auto;display:flex;align-items:center;justify-content:space-between;"><a href="#" ${widgetPartAttr("brand")} style="font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:22px;font-weight:800;color:${tokens.text};text-decoration:none;">${navbarMinimalState.brand}</a><a href="#" ${widgetPartAttr("cta-label")} style="padding:12px 20px;border-radius:${tokens.buttonRadius};background:${tokens.primary};color:#fff;text-decoration:none;font-size:14px;font-weight:700;">${navbarMinimalState.ctaLabel}</a></div></nav>`;
    }
    case "hero": {
      const heroState = {
        eyebrow: "New launch",
      ...
      ], heroState)} style="display:grid;gap:28px;justify-items:start;text-align:left;"><span ${widgetPartAttr("eyebrow")} style="display:inline-flex;align-items:center;gap:8px;padding:8px 14px;border-radius:999px;background:${tokens.softBg};border:1px solid ${primaryGlow};font-size:11px;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:${tokens.primary};">${heroState.eyebrow}</span><div style="max-width:760px;"><h1 style="margin:0 0 18px;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(42px,7vw,82px);line-height:0.98;letter-spacing:-0.04em;color:${tokens.text};"><span ${widgetPartAttr("title")}>${heroState.title}</span><br/><span ${widgetPartAttr("accent")} style="color:${tokens.primary};">${heroState.accent}</span></h1><p ${widgetPartAttr("body")} style="margin:0;max-width:620px;font-size:18px;line-height:1.75;color:${tokens.muted};">${heroState.body}</p></div><div style="display:flex;gap:14px;flex-wrap:wrap;"><a href="#" ${widgetPartAttr("primary-label")} style="display:inline-flex;align-items:center;justify-content:center;padding:16px 24px;border-radius:${tokens.buttonRadius};background:${tokens.primary};color:#fff;text-decoration:none;font-size:15px;font-weight:700;box-shadow:0 14px 32px ${primaryGlow};">${heroState.primaryLabel}</a><a href="#" ${widgetPartAttr("secondary-label")} style="display:inline-flex;align-items:center;justify-content:center;padding:16px 24px;border-radius:${tokens.buttonRadius};border:1px solid ${tokens.border};background:${tokens.bg};color:${tokens.text};text-decoration:none;font-size:15px;font-weight:600;">${heroState.secondaryLabel}</a></div></div>`);
    }
    case "hero-split": {
      ...
      ], heroSplitState)} style="display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:center;"><div style="display:grid;gap:22px;"><h1 style="margin:0;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(36px,5vw,64px);line-height:1.02;letter-spacing:-0.03em;color:${tokens.text};"><span ${widgetPartAttr("title")}>${heroSplitState.title}</span><br/><span ${widgetPartAttr("accent")} style="color:${tokens.primary};">${heroSplitState.accent}</span></h1><p ${widgetPartAttr("body")} style="margin:0;font-size:17px;line-height:1.8;color:${tokens.muted};">${heroSplitState.body}</p><div style="display:flex;gap:12px;flex-wrap:wrap;"><a href="#" ${widgetPartAttr("primary-label")} style="padding:14px 24px;border-radius:${tokens.buttonRadius};background:${tokens.primary};color:#fff;text-decoration:none;font-size:14px;font-weight:700;box-shadow:0 12px 28px ${primaryGlow};">${heroSplitState.primaryLabel}</a><a href="#" ${widgetPartAttr("secondary-label")} style="padding:14px 24px;border-radius:${tokens.buttonRadius};border:1px solid ${tokens.border};color:${tokens.text};text-decoration:none;font-size:14px;font-weight:600;">${heroSplitState.secondaryLabel}</a></div></div><div style="border-radius:${tokens.radius};overflow:hidden;box-shadow:${tokens.shadow};"><img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=900&q=80" alt="Hero" style="width:100%;height:420px;object-fit:cover;display:block;" /></div></div>`);
    }
    case "section": {
      const sectionState = {
    ...
    case "split-image": {
      ...
      ], splitImageState)} style="display:grid;grid-template-columns:1fr 1fr;gap:32px;align-items:center;"><img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=900&q=80" alt="Visual" style="width:100%;height:460px;object-fit:cover;border-radius:${tokens.radius};box-shadow:${tokens.shadow};display:block;" /><div style="display:grid;gap:16px;"><span ${widgetPartAttr("eyebrow")} style="display:inline-flex;padding:6px 12px;border-radius:999px;background:${tokens.softBg};font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:${tokens.primary};width:max-content;">${splitImageState.eyebrow}</span><h2 ${widgetPartAttr("title")} style="margin:0;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(28px,4vw,48px);line-height:1.08;color:${tokens.text};">${splitImageState.title}</h2><p ${widgetPartAttr("body")} style="margin:0;font-size:16px;line-height:1.8;color:${tokens.muted};">${splitImageState.body}</p><a href="#" ${widgetPartAttr("cta-label")} style="display:inline-flex;align-items:center;gap:8px;padding:14px 22px;border-radius:${tokens.buttonRadius};background:${tokens.primary};color:#fff;text-decoration:none;font-size:14px;font-weight:700;width:max-content;box-shadow:0 10px 26px ${primaryGlow};">${splitImageState.ctaLabel}</a></div></div>`);
    }
    case "stats":
      return shell(
        id,
    ...
    case "timeline":
      return shell(
        ...
        "Timeline",
        tokens,
        `<div style="text-align:center;margin-bottom:32px;"><h2 style="margin:0 0 10px;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(28px,4vw,44px);color:${tokens.text};">How it works</h2></div><div ${collectionAttrs("timeline", "Timeline Steps", [
          { key: "title", label: "Title" },
          { key: "description", label: "Description", type: "textarea" },
        ], { fixed: true })} style="display:grid;gap:0;position:relative;">${["Discover", "Design", "Deliver"].map((step, i) => `<div ${collectionItemAttr(`timeline-${i + 1}`)} style="display:grid;grid-template-columns:80px 1fr;gap:20px;padding:24px 0;${i < 2 ? `border-left:2px solid ${tokens.border};margin-left:39px;padding-left:28px;` : ""}"><div style="width:44px;height:44px;border-radius:999px;background:${tokens.primary};color:#fff;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:18px;font-weight:800;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-left:${i > 0 ? "-50px" : "-22px"};box-shadow:0 8px 20px ${primaryGlow};">${i + 1}</div><div><h3 ${collectionFieldAttr("title")} style="margin:0 0 6px;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:20px;color:${tokens.text};">${step}</h3><p ${collectionFieldAttr("description", "textarea")} style="margin:0;font-size:14px;line-height:1.75;color:${tokens.muted};">Brief description of this step goes here. Edit to match your process.</p></div></div>`).join("")}</div>`,
      );
    case "features-list": {
      const listState = {
    ...
    case "testimonials":
      return shell(
        ...
        "Testimonials",
        tokens,
        `<div style="text-align:center;margin-bottom:28px;"><h2 style="margin:0 0 10px;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(28px,4vw,44px);color:${tokens.text};">What people say</h2></div><div ${collectionAttrs("testimonials", "Testimonials", [
          { key: "quote", label: "Quote", type: "textarea" },
          { key: "name", label: "Name" },
          { key: "role", label: "Role" },
        ], { fixed: true })} style="display:grid;grid-template-columns:repeat(3,1fr);gap:18px;">${[
    ...
    case "team":
      return shell(
        ...
        "Team",
        tokens,
        `<div style="text-align:center;margin-bottom:28px;"><h2 style="margin:0 0 10px;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(28px,4vw,44px);color:${tokens.text};">Meet the team</h2><p style="margin:0 auto;max-width:520px;font-size:15px;color:${tokens.muted};">The people behind the work.</p></div><div ${collectionAttrs("team", "Team Members", [
          { key: "image", label: "Photo", type: "image", placeholder: "https://…" },
          { key: "name", label: "Name" },
          { key: "role", label: "Role" },
        ], { fixed: true })} style="display:grid;grid-template-columns:repeat(4,1fr);gap:18px;">${[
    ...
    case "pricing":
      return shell(
        ...
        "Pricing",
        tokens,
        `<div style="text-align:center;margin-bottom:32px;"><h2 style="margin:0 0 10px;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(28px,4vw,44px);color:${tokens.text};">Simple pricing</h2><p style="margin:0 auto;max-width:520px;font-size:15px;color:${tokens.muted};">No hidden fees. Pick a plan and get started today.</p></div><div ${collectionAttrs("pricing", "Pricing Plans", [
          { key: "plan", label: "Plan" },
        ...
        ], { fixed: true })} style="display:grid;grid-template-columns:repeat(3,1fr);gap:18px;align-items:start;">${[
    ...
    case "faq":
      return shell(
        ...
        "FAQ",
        tokens,
        `<div style="text-align:center;margin-bottom:32px;"><h2 style="margin:0 0 10px;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:clamp(28px,4vw,44px);color:${tokens.text};">Frequently asked</h2></div><div ${collectionAttrs("faq", "FAQ Items", [
          { key: "question", label: "Question" },
          { key: "answer", label: "Answer", type: "textarea" },
        ], { fixed: true })} style="max-width:760px;margin:0 auto;display:grid;gap:12px;">${[
    ...
    case "logo-wall":
      return shell(id, "logo-wall", "Logo Wall", tokens, `<div style="text-align:center;margin-bottom:24px;"><p style="margin:0;font-size:12px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:${tokens.muted};">Trusted by teams at</p></div><div data-sz-logo-wall="1" style="display:flex;align-items:center;justify-content:center;gap:32px;flex-wrap:wrap;">${["Vercel","Linear","Figma","Stripe","Notion","Loom"].map(name => `<div data-sz-logo-chip="1" style="padding:12px 22px;border-radius:${tokens.buttonRadius};border:1px solid ${tokens.border};background:${tokens.bg};font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:15px;font-weight:800;color:${tokens.muted};letter-spacing:-.02em;">${name}</div>`).join("")}`, tokens.softBg);
    case "logo-scroller": {
      const logos = ["Vercel","Linear","Figma","Stripe","Notion","Loom","Framer","Slack"];
      const chips = logos.concat(logos).map((name) => `<div data-sz-logo-chip="1" style="padding:12px 22px;border-radius:${tokens.buttonRadius};border:1px solid ${tokens.border};background:${tokens.bg};font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:15px;font-weight:800;color:${tokens.muted};letter-spacing:-.02em;white-space:nowrap;flex:0 0 auto;">${name}</div>`).join("");
      return shell(id, "logo-scroller", "Logo Scroller", tokens, `<div style="text-align:center;margin-bottom:24px;"><p style="margin:0;font-size:12px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:${tokens.muted};">Seen in the workflows of modern teams</p></div><div data-sz-logo-scroller="1" style="position:relative;overflow:hidden;border-radius:${tokens.radius};border:1px solid ${tokens.border};background:${tokens.softBg};padding:18px 0;"><div data-sz-logo-track="1">${chips}</div></div>`, tokens.softBg);
    }
    case "cta-strip": {
      const ctaStripState = {
...
export function buildInlineHtml(blockId: string, project: Project, page?: ProjectPage | null): string {
  ...
  switch (blockId) {
    ...
    case "icon-button":
      return `<div style="margin:0 0 20px;"><a href="#" style="display:inline-flex;align-items:center;justify-content:center;gap:10px;padding:14px 22px;border-radius:${tokens.buttonRadius};background:${tokens.primary};color:#fff;text-decoration:none;font-size:14px;font-weight:700;box-shadow:0 10px 26px ${primaryGlow};"><span data-sz-icon="true" style="display:inline-flex;align-items:center;justify-content:center;line-height:0;color:currentColor;width:18px;height:18px;flex-shrink:0;"><svg viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2.2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" style=\"width:100%;height:100%;\"><path d=\"M5 12h14\"></path><path d=\"m12 5 7 7-7 7\"></path></svg></span><span>Take action</span></a></div>`;
    case "badge":
    ...
    case "floating-button":
      return `<div style="margin:0 0 20px;display:flex;justify-content:flex-end;"><a href="#" style="position:relative;display:inline-flex;align-items:center;gap:10px;padding:12px 18px;border-radius:999px;background:${tokens.primary};color:#fff;text-decoration:none;font-size:13px;font-weight:700;box-shadow:0 14px 30px ${primaryGlow};"><span style="width:10px;height:10px;border-radius:999px;background:#fff;opacity:.92;"></span><span>Chat with us</span></a></div>`;
    case "sidebar-panel":
      return `<aside style="margin:0 0 20px;padding:20px;border-radius:${tokens.radius};background:${tokens.bg};border:1px solid ${tokens.border};box-shadow:${tokens.shadow};display:grid;gap:14px;max-width:320px;"><div><p style="margin:0 0 6px;font-size:12px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:${tokens.primary};">Sidebar</p><h4 style="margin:0;font-family:'${tokens.headingFont}',system-ui,sans-serif;font-size:20px;color:${tokens.text};">Helpful links</h4></div><div style="display:grid;gap:10px;">${["Overview","Pricing","Case studies","Contact"].map((item) => `<a href="#" style="display:flex;align-items:center;justify-content:space-between;padding:11px 12px;border-radius:${tokens.buttonRadius};text-decoration:none;background:${tokens.softBg};border:1px solid rgba(${hexToRgb(tokens.primary)},0.12);color:${tokens.text};font-size:13px;font-weight:600;"><span>${item}</span><span style="color:${tokens.primary};">→</span></a>`).join("")}</div></aside>`;
    case "menu-item":
