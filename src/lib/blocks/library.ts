...
export const BLOCK_LIBRARY: Block[] = [
  ...
  { id: "pricing-toggle",  label: "Pricing Toggle",  cat: "cards",  icon: "⇅",  preview: "Monthly / yearly pricing cards", html: "", placement: "section" },
  ...
  { id: "logo-scroller",   label: "Logo Scroller",   cat: "cards",  icon: "⇢",  preview: "Animated scrolling brand strip", html: "", placement: "section" },
  ...
  { id: "icon-button",     label: "Icon Button",     cat: "text",   icon: "✦",  preview: "Icon-led action chip button",   html: "", placement: "inline"  },
  ...
  { id: "before-after",    label: "Before / After",   cat: "media",  icon: "◧",  preview: "Side-by-side image comparison",  html: "", placement: "inline"  },
  ...
  { id: "floating-button", label: "Floating Button",  cat: "cta",        icon: "⬤",  preview: "Sticky floating CTA chip",  html: "", placement: "inline"  },
  { id: "breadcrumb",      label: "Breadcrumb",       cat: "nav",        icon: "›",  preview: "Compact path navigation",   html: "", placement: "inline"  },
  { id: "pagination",      label: "Pagination",       cat: "nav",        icon: "⇄",  preview: "Previous / next pagination", html: "", placement: "inline"  },
  { id: "sidebar-panel",   label: "Sidebar Panel",    cat: "layout",     icon: "▤",  preview: "Content sidebar with links", html: "", placement: "inline"  },
  { id: "menu-item",       label: "Menu Item",        cat: "cards",      icon: "🍽", preview: "Restaurant menu item card", html: "", placement: "inline"  },
  { id: "modal-popup",     label: "Modal Popup",      cat: "cta",        icon: "◫",  preview: "Openable modal callout",    html: "", placement: "inline"  },
  ...
  { id: "carousel",        label: "Carousel",         cat: "media",  icon: "⇆",  preview: "Image and content carousel",    html: "", placement: "section" },
  { id: "testimonial-slider", label: "Testimonial Slider", cat: "cards", icon: "❝", preview: "Sliding testimonials section", html: "", placement: "section" },
